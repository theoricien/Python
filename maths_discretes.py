...
def ex_1():
	print("Reponse:",[(nb_x*x + nb_y*y) % mod for nb_x in [int(input("Coeff de x: "))] for nb_y in [int(input("Coeff de y: "))] for mod in [int(input("Modulo: "))] for x in range(3) for y in range(3)],end='')
